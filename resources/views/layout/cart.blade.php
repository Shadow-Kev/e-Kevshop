      ...
      @include('layout._market-shipsteps')
        ...
        <section class="shopping-cart padding-bottom-60">
          <div class="container">
            ...
            <a href="{{url(route('modeLivraisonCli'))}}" class="btn-round"> Suivant <span><i class="fa fa-arrow-circle-right"></i></span></a> </div>
            ...
            <section>
                <div class="container">
                    <div class="order-success error-page" style="max-width:320px;margin: 50px auto;"> <img style="max-width: 200px;"   src="{{asset('assets/images/empty-cart-icon.png')}}" alt="">
                        ...
                        <div>
                            <a href="{{URL::to('/store')}}" class="btn-round btn-light text-white" style="color: white;">
