...
@section('content')
    ...
    {!! Form::open(['url' => 'manager/promotion', 'class' => 'form-horizontal']) !!}
    @if ($errors->any())
    ...
    @endif
            ...
            <div class="form-group row {{ $errors->has('produit') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-9">
                    {!! Form::select('produit', \App\Produit::where('deleted_at',null)->pluck('nom','id'), old('produit'), ['placeholder' => 'Choisissez un  produit','class' => 'form-control']) !!}
