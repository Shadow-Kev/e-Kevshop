            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="body-content">
                        <h4 style="color:red;font-size:20px;">Nos codes de réduction</h4>
                        <p style="font-size:1.5rem;line-height:20px;text-align:justify;" >
                           KADMARKET vous offre la possibilité d'acheter des articles à des prix très bas à travers l’activation d’un code de réduction. Le code de réduction vous donne droit à une remise exceptionnelle sur un achat effectué en ligne. 
                        </p>

                        <h4 style="color:red;font-size:20px;">Comment procéder ?</h4>
                        <p>
                           Pour profiter de cette offre, 3 étapes à suivre :

                            <ol style="text-align:justify;">
                                <li style="font-size:1.5rem;line-height:20px;margin-bottom:10px;">Remplissez le formulaire ci-après avec votre nom (et prénom), votre contact valide et le code d’un KADMARKETEUR, si vous avez été recommandé. Cliquez ensuite sur le bouton  <b>Générer le code </b> </li>
                                <li style="font-size:1.5rem;line-height:20px;margin-bottom:10px;">Une fois le code généré, vous devez l'activer en effectuant le paiement, via <b>Airtel Money</b>. Pour cela, cliquez sur le bouton <b>Payer pour activer.</b>  Après paiement, votre code est automatiquement activé.</li>
                                <li style="font-size:1.5rem;line-height:20px;margin-bottom:10px;"> Une fois le paiement effectué, ajoutez des produits à votre panier, puis procédez à la commande ou cliquez sur l'icône du panier située en bas de votre écran. Vous aurez ainsi la liste des produits sélectionnés et un champ en haut réservé pour le code de réduction. Saisissez votre code puis cliquez sur <b>APPLIQUER</b></li>
