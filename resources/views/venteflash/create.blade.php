...
@section('content')
    ...
    <h1>Nouvelle Vente Flash</h1>
    <hr/>

    {!! Form::open(['url' => 'venteflash', 'class' => 'form-horizontal']) !!}
    @if ($errors->any())
    ...
    @endif
            ...
            <div class="form-group {{ $errors->has('produit') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-8">
                    {!! Form::select('produit', \App\Produit::pluck('nom','id'), null, ['placeholder' => 'Choisissez un  produit','class' => 'form-control']) !!}
